...
LEGENDS = {'Weight': 'Weight in kg', 'Height': 'Height in cm',
            ...
            'Fasting total cholesterol': 'Fasting total cholesterol in mg/dl',
            'Fasting LDL cholesterol': 'Fasting LDL in mg/dl',
            'Fasting HDL cholesterol': 'Fasting HDL in mg/dl',
            'Fasting triglycerides': 'Fasting tryglycerides in mg/dl',
            'Apo-A1': 'Apo-A1 in g/l', 'AST': 'AST in U/l',
            'ALT': 'ALT in U/l', 'gGT': 'gGT in U/l',
            'haptoglobin': 'Haptoglobin in U/L',
            'α-2-macroglobulin': 'a2 macroglobulin in g/l',
            'Fasting glycemia': 'Fasting glycemia (mg/dl)',
            'Average Fasting Glucose': 'Fasting glycemia (mg/dl)',
            'Average Fasting Insulin': 'Fasting insulin (mU/l)',
            'Average Fasting C peptide': 'Fasting C peptide (mU/l)',
            'Matsuda index': 'Matsuda Index', 'HOMA ISI': 'HOMA ISI Index',
            'Stumvoll First Phase': 'Stumvoll 1PH',
            'Stumvoll Second Phase': 'Stumvoll 2PH',
